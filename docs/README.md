...
- [ArchLinux AUR](https://aur.archlinux.org/packages/metacall-git) using your favorite AUR helper, `sudo aura -Axc metacall-git` or `paru -S metacall-git` (for Arch users).
