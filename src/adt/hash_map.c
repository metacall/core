...
int hash_map_bucket_capacity(int prime)
{
	...
	if (prime >= 0 && prime < sizeof(capacity_primes) / sizeof(capacity_primes[0]))
	{
...
int hash_map_bucket_create(hash_map map, int prime)
{
