...
pub const METACALL_ALLOCATOR_STD: c_int = 0;
pub const METACALL_ALLOCATOR_NGINX: c_int = 1;
pub const enum_metacall_allocator_id = c_uint;
pub const struct_ngx_pool_s = opaque {};
pub const struct_metacall_allocator_std_type = extern struct {
...
pub const metacall_allocator_std = [*c]struct_metacall_allocator_std_type;
pub const ngx_pool_t = struct_ngx_pool_s;
pub const struct_metacall_allocator_nginx_type = extern struct {
    pool: ?*ngx_pool_t = @import("std").mem.zeroes(?*ngx_pool_t),
    palloc: ?*const fn (?*ngx_pool_t, usize) callconv(.C) ?*anyopaque = @import("std").mem.zeroes(?*const fn (?*ngx_pool_t, usize) callconv(.C) ?*anyopaque),
    pcopy: ?*const fn (?*anyopaque, ?*const anyopaque, usize) callconv(.C) ?*anyopaque = @import("std").mem.zeroes(?*const fn (?*anyopaque, ?*const anyopaque, usize) callconv(.C) ?*anyopaque),
    pfree: ?*const fn (?*ngx_pool_t, ?*anyopaque) callconv(.C) isize = @import("std").mem.zeroes(?*const fn (?*ngx_pool_t, ?*anyopaque) callconv(.C) isize),
};
pub const metacall_allocator_nginx = [*c]struct_metacall_allocator_nginx_type;
pub extern fn metacall_allocator_create(allocator_id: enum_metacall_allocator_id, ctx: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_allocator_alloc(allocator: ?*anyopaque, size: usize) ?*anyopaque;
pub extern fn metacall_allocator_realloc(allocator: ?*anyopaque, data: ?*anyopaque, size: usize, new_size: usize) ?*anyopaque;
pub extern fn metacall_allocator_free(allocator: ?*anyopaque, data: ?*anyopaque) void;
pub extern fn metacall_allocator_destroy(allocator: ?*anyopaque) void;
pub const struct_metacall_exception_type = extern struct {
    message: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    label: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    code: i64 = @import("std").mem.zeroes(i64),
    stacktrace: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
};
pub const metacall_exception = [*c]struct_metacall_exception_type;
pub extern fn metacall_error_from_value(v: ?*anyopaque, ex: metacall_exception) c_int;
pub extern fn metacall_error_last(ex: metacall_exception) c_int;
pub extern fn metacall_error_clear() void;
...
pub const METACALL_LOG_STDIO: c_int = 0;
pub const METACALL_LOG_FILE: c_int = 1;
pub const METACALL_LOG_SOCKET: c_int = 2;
pub const METACALL_LOG_SYSLOG: c_int = 3;
pub const METACALL_LOG_NGINX: c_int = 4;
pub const METACALL_LOG_CUSTOM: c_int = 5;
pub const enum_metacall_log_id = c_uint;
pub const struct_metacall_log_stdio_type = extern struct {
    stream: [*c]FILE = @import("std").mem.zeroes([*c]FILE),
};
pub const struct_metacall_log_file_type = extern struct {
    file_name: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    mode: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
};
pub const struct_metacall_log_socket_type = extern struct {
    ip: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    port: u16 = @import("std").mem.zeroes(u16),
};
pub const struct_metacall_log_syslog_type = extern struct {
    name: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
};
pub const struct_metacall_log_nginx_type = extern struct {
    log: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    log_error: ?*const fn () callconv(.C) void = @import("std").mem.zeroes(?*const fn () callconv(.C) void),
    log_level: u16 = @import("std").mem.zeroes(u16),
};
pub const struct_metacall_log_custom_va_list_type = extern struct {
    va: va_list = @import("std").mem.zeroes(va_list),
};
pub const metacall_log_custom_va_list = [*c]struct_metacall_log_custom_va_list_type;
pub const struct_metacall_log_custom_type = extern struct {
    context: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    format_size: ?*const fn (?*anyopaque, [*c]const u8, u64, usize, [*c]const u8, [*c]const u8, [*c]const u8, [*c]const u8, metacall_log_custom_va_list) callconv(.C) usize = @import("std").mem.zeroes(?*const fn (?*anyopaque, [*c]const u8, u64, usize, [*c]const u8, [*c]const u8, [*c]const u8, [*c]const u8, metacall_log_custom_va_list) callconv(.C) usize),
    format_serialize: ?*const fn (?*anyopaque, ?*anyopaque, usize, [*c]const u8, u64, usize, [*c]const u8, [*c]const u8, [*c]const u8, [*c]const u8, metacall_log_custom_va_list) callconv(.C) usize = @import("std").mem.zeroes(?*const fn (?*anyopaque, ?*anyopaque, usize, [*c]const u8, u64, usize, [*c]const u8, [*c]const u8, [*c]const u8, [*c]const u8, metacall_log_custom_va_list) callconv(.C) usize),
    format_deserialize: ?*const fn (?*anyopaque, ?*const anyopaque, usize, [*c]const u8, u64, usize, [*c]const u8, [*c]const u8, [*c]const u8, [*c]const u8, metacall_log_custom_va_list) callconv(.C) usize = @import("std").mem.zeroes(?*const fn (?*anyopaque, ?*const anyopaque, usize, [*c]const u8, u64, usize, [*c]const u8, [*c]const u8, [*c]const u8, [*c]const u8, metacall_log_custom_va_list) callconv(.C) usize),
    stream_write: ?*const fn (?*anyopaque, [*c]const u8, usize) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*anyopaque, [*c]const u8, usize) callconv(.C) c_int),
    stream_flush: ?*const fn (?*anyopaque) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*anyopaque) callconv(.C) c_int),
};
pub const metacall_log_stdio = [*c]struct_metacall_log_stdio_type;
pub const metacall_log_file = [*c]struct_metacall_log_file_type;
pub const metacall_log_socket = [*c]struct_metacall_log_socket_type;
pub const metacall_log_syslog = [*c]struct_metacall_log_syslog_type;
pub const metacall_log_nginx = [*c]struct_metacall_log_nginx_type;
pub const metacall_log_custom = [*c]struct_metacall_log_custom_type;
pub extern fn metacall_log(log_id: enum_metacall_log_id, ctx: ?*anyopaque) c_int;
pub const METACALL_BOOL: c_int = 0;
pub const METACALL_CHAR: c_int = 1;
pub const METACALL_SHORT: c_int = 2;
pub const METACALL_INT: c_int = 3;
pub const METACALL_LONG: c_int = 4;
pub const METACALL_FLOAT: c_int = 5;
pub const METACALL_DOUBLE: c_int = 6;
pub const METACALL_STRING: c_int = 7;
pub const METACALL_BUFFER: c_int = 8;
pub const METACALL_ARRAY: c_int = 9;
pub const METACALL_MAP: c_int = 10;
pub const METACALL_PTR: c_int = 11;
pub const METACALL_FUTURE: c_int = 12;
pub const METACALL_FUNCTION: c_int = 13;
pub const METACALL_NULL: c_int = 14;
pub const METACALL_CLASS: c_int = 15;
pub const METACALL_OBJECT: c_int = 16;
pub const METACALL_EXCEPTION: c_int = 17;
pub const METACALL_THROWABLE: c_int = 18;
pub const METACALL_SIZE: c_int = 19;
pub const METACALL_INVALID: c_int = 20;
pub const enum_metacall_value_id = c_uint;
pub extern fn metacall_value_create_bool(b: u8) ?*anyopaque;
pub extern fn metacall_value_create_char(c: u8) ?*anyopaque;
pub extern fn metacall_value_create_short(s: c_short) ?*anyopaque;
pub extern fn metacall_value_create_int(i: c_int) ?*anyopaque;
pub extern fn metacall_value_create_long(l: c_long) ?*anyopaque;
pub extern fn metacall_value_create_float(f: f32) ?*anyopaque;
pub extern fn metacall_value_create_double(d: f64) ?*anyopaque;
pub extern fn metacall_value_create_string(str: [*c]const u8, length: usize) ?*anyopaque;
pub extern fn metacall_value_create_buffer(buffer: ?*const anyopaque, size: usize) ?*anyopaque;
pub extern fn metacall_value_create_array(values: [*c]?*const anyopaque, size: usize) ?*anyopaque;
pub extern fn metacall_value_create_map(tuples: [*c]?*const anyopaque, size: usize) ?*anyopaque;
pub extern fn metacall_value_create_ptr(ptr: ?*const anyopaque) ?*anyopaque;
pub extern fn metacall_value_create_future(f: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_create_function(f: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_create_function_closure(f: ?*anyopaque, c: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_create_null() ?*anyopaque;
pub extern fn metacall_value_create_class(c: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_create_object(o: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_create_exception(ex: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_create_throwable(th: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_size(v: ?*anyopaque) usize;
pub extern fn metacall_value_count(v: ?*anyopaque) usize;
pub extern fn metacall_value_id(v: ?*anyopaque) enum_metacall_value_id;
pub extern fn metacall_value_id_name(id: enum_metacall_value_id) [*c]const u8;
pub extern fn metacall_value_type_name(v: ?*anyopaque) [*c]const u8;
pub extern fn metacall_value_copy(v: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_move(src: ?*anyopaque, dest: ?*anyopaque) void;
pub extern fn metacall_value_to_bool(v: ?*anyopaque) u8;
pub extern fn metacall_value_to_char(v: ?*anyopaque) u8;
pub extern fn metacall_value_to_short(v: ?*anyopaque) c_short;
pub extern fn metacall_value_to_int(v: ?*anyopaque) c_int;
pub extern fn metacall_value_to_long(v: ?*anyopaque) c_long;
pub extern fn metacall_value_to_float(v: ?*anyopaque) f32;
pub extern fn metacall_value_to_double(v: ?*anyopaque) f64;
pub extern fn metacall_value_to_string(v: ?*anyopaque) [*c]u8;
pub extern fn metacall_value_to_buffer(v: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_to_array(v: ?*anyopaque) [*c]?*anyopaque;
pub extern fn metacall_value_to_map(v: ?*anyopaque) [*c]?*anyopaque;
pub extern fn metacall_value_to_ptr(v: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_to_future(v: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_to_function(v: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_to_null(v: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_to_class(v: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_to_object(v: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_to_exception(v: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_to_throwable(v: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_from_bool(v: ?*anyopaque, b: u8) ?*anyopaque;
pub extern fn metacall_value_from_char(v: ?*anyopaque, c: u8) ?*anyopaque;
pub extern fn metacall_value_from_short(v: ?*anyopaque, s: c_short) ?*anyopaque;
pub extern fn metacall_value_from_int(v: ?*anyopaque, i: c_int) ?*anyopaque;
pub extern fn metacall_value_from_long(v: ?*anyopaque, l: c_long) ?*anyopaque;
pub extern fn metacall_value_from_float(v: ?*anyopaque, f: f32) ?*anyopaque;
pub extern fn metacall_value_from_double(v: ?*anyopaque, d: f64) ?*anyopaque;
pub extern fn metacall_value_from_string(v: ?*anyopaque, str: [*c]const u8, length: usize) ?*anyopaque;
pub extern fn metacall_value_from_buffer(v: ?*anyopaque, buffer: ?*const anyopaque, size: usize) ?*anyopaque;
pub extern fn metacall_value_from_array(v: ?*anyopaque, values: [*c]?*const anyopaque, size: usize) ?*anyopaque;
pub extern fn metacall_value_from_map(v: ?*anyopaque, tuples: [*c]?*const anyopaque, size: usize) ?*anyopaque;
pub extern fn metacall_value_from_ptr(v: ?*anyopaque, ptr: ?*const anyopaque) ?*anyopaque;
pub extern fn metacall_value_from_future(v: ?*anyopaque, f: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_from_function(v: ?*anyopaque, f: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_from_null(v: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_from_class(v: ?*anyopaque, c: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_from_object(v: ?*anyopaque, o: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_from_exception(v: ?*anyopaque, ex: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_from_throwable(v: ?*anyopaque, th: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_cast(v: ?*anyopaque, id: enum_metacall_value_id) ?*anyopaque;
pub extern fn metacall_value_cast_bool(v: [*c]?*anyopaque) u8;
pub extern fn metacall_value_cast_char(v: [*c]?*anyopaque) u8;
pub extern fn metacall_value_cast_short(v: [*c]?*anyopaque) c_short;
pub extern fn metacall_value_cast_int(v: [*c]?*anyopaque) c_int;
pub extern fn metacall_value_cast_long(v: [*c]?*anyopaque) c_long;
pub extern fn metacall_value_cast_float(v: [*c]?*anyopaque) f32;
pub extern fn metacall_value_cast_double(v: [*c]?*anyopaque) f64;
pub extern fn metacall_value_cast_string(v: [*c]?*anyopaque) [*c]u8;
pub extern fn metacall_value_cast_buffer(v: [*c]?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_cast_array(v: [*c]?*anyopaque) [*c]?*anyopaque;
pub extern fn metacall_value_cast_map(v: [*c]?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_cast_ptr(v: [*c]?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_cast_future(v: [*c]?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_cast_function(v: [*c]?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_cast_null(v: [*c]?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_cast_class(v: [*c]?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_cast_object(v: [*c]?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_cast_exception(v: [*c]?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_cast_throwable(v: [*c]?*anyopaque) ?*anyopaque;
pub extern fn metacall_value_destroy(v: ?*anyopaque) void;
...
pub const metacall_pid = pid_t;
pub const metacall_pre_fork_callback_ptr = ?*const fn (?*anyopaque) callconv(.C) c_int;
...
pub const metacall_await_callback = ?*const fn (?*anyopaque, ?*anyopaque) callconv(.C) ?*anyopaque;
pub const struct_metacall_await_callbacks_type = extern struct {
    resolve: metacall_await_callback = @import("std").mem.zeroes(metacall_await_callback),
    reject: metacall_await_callback = @import("std").mem.zeroes(metacall_await_callback),
};
pub const metacall_await_callbacks = struct_metacall_await_callbacks_type;
pub const struct_metacall_version_type = extern struct {
    major: c_uint = @import("std").mem.zeroes(c_uint),
    minor: c_uint = @import("std").mem.zeroes(c_uint),
    patch: c_uint = @import("std").mem.zeroes(c_uint),
    revision: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    str: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    name: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
};
pub extern var metacall_null_args: [1]?*anyopaque;
pub extern fn metacall_serial() [*c]const u8;
pub extern fn metacall_log_null() void;
pub extern fn metacall_flags(flags: c_int) void;
pub extern fn metacall_initialize() c_int;
pub extern fn metacall_initialize_ex(initialize_config: [*c]struct_metacall_initialize_configuration_type) c_int;
pub extern fn metacall_initialize_args(argc: c_int, argv: [*c][*c]u8) void;
pub extern fn metacall_argc() c_int;
pub extern fn metacall_argv() [*c][*c]u8;
pub extern fn metacall_is_initialized(tag: [*c]const u8) c_int;
pub extern fn metacall_args_size() usize;
pub extern fn metacall_execution_path(tag: [*c]const u8, path: [*c]const u8) c_int;
pub extern fn metacall_execution_path_s(tag: [*c]const u8, tag_length: usize, path: [*c]const u8, path_length: usize) c_int;
pub extern fn metacall_load_from_file(tag: [*c]const u8, paths: [*c][*c]const u8, size: usize, handle: [*c]?*anyopaque) c_int;
pub extern fn metacall_load_from_memory(tag: [*c]const u8, buffer: [*c]const u8, size: usize, handle: [*c]?*anyopaque) c_int;
pub extern fn metacall_load_from_package(tag: [*c]const u8, path: [*c]const u8, handle: [*c]?*anyopaque) c_int;
pub extern fn metacall_load_from_configuration(path: [*c]const u8, handle: [*c]?*anyopaque, allocator: ?*anyopaque) c_int;
pub extern fn metacallv(name: [*c]const u8, args: [*c]?*anyopaque) ?*anyopaque;
pub extern fn metacallv_s(name: [*c]const u8, args: [*c]?*anyopaque, size: usize) ?*anyopaque;
pub extern fn metacallhv(handle: ?*anyopaque, name: [*c]const u8, args: [*c]?*anyopaque) ?*anyopaque;
pub extern fn metacallhv_s(handle: ?*anyopaque, name: [*c]const u8, args: [*c]?*anyopaque, size: usize) ?*anyopaque;
pub extern fn metacall(name: [*c]const u8, ...) ?*anyopaque;
pub extern fn metacallt(name: [*c]const u8, ids: [*c]const enum_metacall_value_id, ...) ?*anyopaque;
pub extern fn metacallt_s(name: [*c]const u8, ids: [*c]const enum_metacall_value_id, size: usize, ...) ?*anyopaque;
pub extern fn metacallht_s(handle: ?*anyopaque, name: [*c]const u8, ids: [*c]const enum_metacall_value_id, size: usize, ...) ?*anyopaque;
pub extern fn metacall_function(name: [*c]const u8) ?*anyopaque;
pub extern fn metacall_handle_function(handle: ?*anyopaque, name: [*c]const u8) ?*anyopaque;
pub extern fn metacall_function_parameter_type(func: ?*anyopaque, parameter: usize, id: [*c]enum_metacall_value_id) c_int;
pub extern fn metacall_function_return_type(func: ?*anyopaque, id: [*c]enum_metacall_value_id) c_int;
pub extern fn metacall_function_size(func: ?*anyopaque) usize;
pub extern fn metacall_function_async(func: ?*anyopaque) c_int;
pub extern fn metacall_handle(tag: [*c]const u8, name: [*c]const u8) ?*anyopaque;
pub extern fn metacall_handle_id(handle: ?*anyopaque) [*c]const u8;
pub extern fn metacall_handle_export(handle: ?*anyopaque) ?*anyopaque;
pub extern fn metacallfv(func: ?*anyopaque, args: [*c]?*anyopaque) ?*anyopaque;
pub extern fn metacallfv_s(func: ?*anyopaque, args: [*c]?*anyopaque, size: usize) ?*anyopaque;
pub extern fn metacallf(func: ?*anyopaque, ...) ?*anyopaque;
pub extern fn metacallfs(func: ?*anyopaque, buffer: [*c]const u8, size: usize, allocator: ?*anyopaque) ?*anyopaque;
pub extern fn metacallfmv(func: ?*anyopaque, keys: [*c]?*anyopaque, values: [*c]?*anyopaque) ?*anyopaque;
pub extern fn metacallfms(func: ?*anyopaque, buffer: [*c]const u8, size: usize, allocator: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_register(name: [*c]const u8, invoke: ?*const fn (usize, [*c]?*anyopaque, ?*anyopaque) callconv(.C) ?*anyopaque, func: [*c]?*anyopaque, return_type: enum_metacall_value_id, size: usize, ...) c_int;
pub extern fn metacall_registerv(name: [*c]const u8, invoke: ?*const fn (usize, [*c]?*anyopaque, ?*anyopaque) callconv(.C) ?*anyopaque, func: [*c]?*anyopaque, return_type: enum_metacall_value_id, size: usize, types: [*c]enum_metacall_value_id) c_int;
pub extern fn metacall_register_loaderv(loader: ?*anyopaque, context: ?*anyopaque, name: [*c]const u8, invoke: ?*const fn (usize, [*c]?*anyopaque, ?*anyopaque) callconv(.C) ?*anyopaque, return_type: enum_metacall_value_id, size: usize, types: [*c]enum_metacall_value_id) c_int;
pub extern fn metacall_await(name: [*c]const u8, args: [*c]?*anyopaque, resolve_callback: ?*const fn (?*anyopaque, ?*anyopaque) callconv(.C) ?*anyopaque, reject_callback: ?*const fn (?*anyopaque, ?*anyopaque) callconv(.C) ?*anyopaque, data: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_await_future(f: ?*anyopaque, resolve_callback: ?*const fn (?*anyopaque, ?*anyopaque) callconv(.C) ?*anyopaque, reject_callback: ?*const fn (?*anyopaque, ?*anyopaque) callconv(.C) ?*anyopaque, data: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_await_s(name: [*c]const u8, args: [*c]?*anyopaque, size: usize, resolve_callback: ?*const fn (?*anyopaque, ?*anyopaque) callconv(.C) ?*anyopaque, reject_callback: ?*const fn (?*anyopaque, ?*anyopaque) callconv(.C) ?*anyopaque, data: ?*anyopaque) ?*anyopaque;
pub extern fn metacallfv_await(func: ?*anyopaque, args: [*c]?*anyopaque, resolve_callback: ?*const fn (?*anyopaque, ?*anyopaque) callconv(.C) ?*anyopaque, reject_callback: ?*const fn (?*anyopaque, ?*anyopaque) callconv(.C) ?*anyopaque, data: ?*anyopaque) ?*anyopaque;
pub extern fn metacallfv_await_s(func: ?*anyopaque, args: [*c]?*anyopaque, size: usize, resolve_callback: ?*const fn (?*anyopaque, ?*anyopaque) callconv(.C) ?*anyopaque, reject_callback: ?*const fn (?*anyopaque, ?*anyopaque) callconv(.C) ?*anyopaque, data: ?*anyopaque) ?*anyopaque;
pub extern fn metacallfv_await_struct_s(func: ?*anyopaque, args: [*c]?*anyopaque, size: usize, cb: metacall_await_callbacks, data: ?*anyopaque) ?*anyopaque;
pub extern fn metacallfmv_await(func: ?*anyopaque, keys: [*c]?*anyopaque, values: [*c]?*anyopaque, resolve_callback: ?*const fn (?*anyopaque, ?*anyopaque) callconv(.C) ?*anyopaque, reject_callback: ?*const fn (?*anyopaque, ?*anyopaque) callconv(.C) ?*anyopaque, data: ?*anyopaque) ?*anyopaque;
pub extern fn metacallfmv_await_s(func: ?*anyopaque, keys: [*c]?*anyopaque, values: [*c]?*anyopaque, size: usize, resolve_callback: ?*const fn (?*anyopaque, ?*anyopaque) callconv(.C) ?*anyopaque, reject_callback: ?*const fn (?*anyopaque, ?*anyopaque) callconv(.C) ?*anyopaque, data: ?*anyopaque) ?*anyopaque;
pub extern fn metacallfs_await(func: ?*anyopaque, buffer: [*c]const u8, size: usize, allocator: ?*anyopaque, resolve_callback: ?*const fn (?*anyopaque, ?*anyopaque) callconv(.C) ?*anyopaque, reject_callback: ?*const fn (?*anyopaque, ?*anyopaque) callconv(.C) ?*anyopaque, data: ?*anyopaque) ?*anyopaque;
pub extern fn metacallfms_await(func: ?*anyopaque, buffer: [*c]const u8, size: usize, allocator: ?*anyopaque, resolve_callback: ?*const fn (?*anyopaque, ?*anyopaque) callconv(.C) ?*anyopaque, reject_callback: ?*const fn (?*anyopaque, ?*anyopaque) callconv(.C) ?*anyopaque, data: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_class(name: [*c]const u8) ?*anyopaque;
pub extern fn metacallv_class(cls: ?*anyopaque, name: [*c]const u8, args: [*c]?*anyopaque, size: usize) ?*anyopaque;
pub extern fn metacallt_class(cls: ?*anyopaque, name: [*c]const u8, ret: enum_metacall_value_id, args: [*c]?*anyopaque, size: usize) ?*anyopaque;
pub extern fn metacall_class_new(cls: ?*anyopaque, name: [*c]const u8, args: [*c]?*anyopaque, size: usize) ?*anyopaque;
pub extern fn metacall_class_static_get(cls: ?*anyopaque, key: [*c]const u8) ?*anyopaque;
pub extern fn metacall_class_static_set(cls: ?*anyopaque, key: [*c]const u8, v: ?*anyopaque) c_int;
pub extern fn metacallv_object(obj: ?*anyopaque, name: [*c]const u8, args: [*c]?*anyopaque, size: usize) ?*anyopaque;
pub extern fn metacallt_object(obj: ?*anyopaque, name: [*c]const u8, ret: enum_metacall_value_id, args: [*c]?*anyopaque, size: usize) ?*anyopaque;
pub extern fn metacall_object_get(obj: ?*anyopaque, key: [*c]const u8) ?*anyopaque;
pub extern fn metacall_object_set(obj: ?*anyopaque, key: [*c]const u8, v: ?*anyopaque) c_int;
pub extern fn metacall_throwable_value(th: ?*anyopaque) ?*anyopaque;
pub extern fn metacall_inspect(size: [*c]usize, allocator: ?*anyopaque) [*c]u8;
pub extern fn metacall_inspect_value() ?*anyopaque;
pub extern fn metacall_serialize(name: [*c]const u8, v: ?*anyopaque, size: [*c]usize, allocator: ?*anyopaque) [*c]u8;
pub extern fn metacall_deserialize(name: [*c]const u8, buffer: [*c]const u8, size: usize, allocator: ?*anyopaque) ?*anyopaque;
...
pub extern fn metacall_version_str() [*c]const u8;
pub extern fn metacall_version_revision() [*c]const u8;
pub extern fn metacall_version_name() [*c]const u8;
pub extern fn metacall_print_info() [*c]const u8;
...
pub const METACALL_API = @compileError("unable to translate macro: undefined identifier `visibility`"); // ../../../../build/source/metacall/include/metacall/metacall_api.h:15:15
pub const METACALL_NO_EXPORT = @compileError("unable to translate macro: undefined identifier `visibility`"); // ../../../../build/source/metacall/include/metacall/metacall_api.h:20:13
pub const METACALL_DEPRECATED = @compileError("unable to translate macro: undefined identifier `__deprecated__`"); // ../../../../build/source/metacall/include/metacall/metacall_api.h:25:11
...
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // /home/raymond/.zvm/master/lib/include/stdarg.h:33:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // /home/raymond/.zvm/master/lib/include/stdarg.h:35:9
pub const va_arg = @compileError("unable to translate C expr: unexpected token 'an identifier'"); // /home/raymond/.zvm/master/lib/include/stdarg.h:36:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /home/raymond/.zvm/master/lib/include/stdarg.h:41:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /home/raymond/.zvm/master/lib/include/stdarg.h:46:9
...
pub const METACALL_H = @as(c_int, 1);
pub const METACALL_API_H = "";
pub const METACALL_DEPRECATED_EXPORT = METACALL_API ++ METACALL_DEPRECATED;
pub const METACALL_DEPRECATED_NO_EXPORT = METACALL_NO_EXPORT ++ METACALL_DEPRECATED;
pub const METACALL_ALLOCATOR_H = @as(c_int, 1);
...
pub const METACALL_DEF_H = @as(c_int, 1);
pub const METACALL_FORK_SAFE = @as(c_int, 1);
pub const METACALL_ERROR_H = @as(c_int, 1);
pub const METACALL_LOG_H = @as(c_int, 1);
...
pub const METACALL_VALUE_H = @as(c_int, 1);
pub const boolean = u8;
pub const METACALL_VERSION_H = @as(c_int, 1);
pub const METACALL_PROJECT_NAME = "MetaCall";
pub const METACALL_PROJECT_DESCRIPTION = "A library for providing inter-language foreign function interface calls";
pub const METACALL_AUTHOR_ORGANIZATION = "MetaCall Inc.";
pub const METACALL_AUTHOR_DOMAIN = "https://metacall.io/";
pub const METACALL_AUTHOR_MAINTAINER = "vic798@gmail.com";
pub const METACALL_VERSION_MAJOR = "0";
pub const METACALL_VERSION_MAJOR_ID = @as(c_int, 0);
pub const METACALL_VERSION_MINOR = "7";
pub const METACALL_VERSION_MINOR_ID = @as(c_int, 7);
pub const METACALL_VERSION_PATCH = "5";
pub const METACALL_VERSION_PATCH_ID = @as(c_int, 5);
pub const METACALL_VERSION_REVISION = "34b28423138e";
pub const METACALL_VERSION = "0.7.5";
pub const METACALL_NAME_VERSION = "MetaCall v0.7.5 (34b28423138e)";
pub const METACALL_FORK_H = @as(c_int, 1);
...
pub const METACALL_FLAGS_FORK_SAFE = @as(c_int, 0x01) << @as(c_int, 0x00);
...
pub const metacall_allocator_id = enum_metacall_allocator_id;
pub const ngx_pool_s = struct_ngx_pool_s;
pub const metacall_allocator_std_type = struct_metacall_allocator_std_type;
pub const metacall_allocator_nginx_type = struct_metacall_allocator_nginx_type;
pub const metacall_exception_type = struct_metacall_exception_type;
...
pub const metacall_log_id = enum_metacall_log_id;
pub const metacall_log_stdio_type = struct_metacall_log_stdio_type;
pub const metacall_log_file_type = struct_metacall_log_file_type;
pub const metacall_log_socket_type = struct_metacall_log_socket_type;
pub const metacall_log_syslog_type = struct_metacall_log_syslog_type;
pub const metacall_log_nginx_type = struct_metacall_log_nginx_type;
pub const metacall_log_custom_va_list_type = struct_metacall_log_custom_va_list_type;
pub const metacall_log_custom_type = struct_metacall_log_custom_type;
pub const metacall_initialize_configuration_type = struct_metacall_initialize_configuration_type;
pub const metacall_await_callbacks_type = struct_metacall_await_callbacks_type;
pub const metacall_version_type = struct_metacall_version_type;
