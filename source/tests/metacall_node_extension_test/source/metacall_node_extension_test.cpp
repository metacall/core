...
class metacall_node_extension_test : public testing::Test
{
public:
};

TEST_F(metacall_node_extension_test, DefaultConstructor)
{
	metacall_print_info();
...
/* NodeJS */
#if defined(OPTION_BUILD_LOADERS_NODE)
	{
		...
		ret = metacallv("hello", metacall_null_args);
