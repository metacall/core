...
class metacall_node_async_multiple_test : public testing::Test
{
public:
};

TEST_F(metacall_node_async_multiple_test, DefaultConstructor)
{
...
/* NodeJS */
#if defined(OPTION_BUILD_LOADERS_NODE)
	{
		...
		EXPECT_EQ((int)success_callbacks, (int)(3 * iteration_size));
	}
#endif /* OPTION_BUILD_LOADERS_NODE */
}
