...
These tests complement the existing `metacall_lua_test` by focusing on
boundary conditions and error scenarios rather than basic functionality.
For the loader design decisions and value conversion rules, see
`source/loaders/lua_loader/README.md`.
...
### 2. String Edge Case Tests (4 tests)
...
- **convert_exceeds_recursion_limit**: Beyond 1000-level recursion limit
