...
class metacall_file_glob_test : public testing::Test
{
public:
};

TEST_F(metacall_file_glob_test, DefaultConstructor)
{
	metacall_print_info();
	...
	EXPECT_NE((void *)NULL, (void *)metacall_function("glob/a.txt"));
	EXPECT_NE((void *)NULL, (void *)metacall_function("glob/b.txt"));
	EXPECT_EQ((void *)NULL, (void *)metacall_function("glob/c.json"));
