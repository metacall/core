...
class value_cast_int_test : public testing::Test
{
  public:
};

TEST_F(value_cast_int_test, int_to_bool_cast)
{
...
TEST_F(value_cast_int_test, int_to_char_cast)
{
	value v = value_create_int(123474);
...
TEST_F(value_cast_int_test, int_to_short_cast)
{
	value v = value_create_int(123474);
...
TEST_F(value_cast_int_test, int_to_int_cast)
{
	value v = value_create_int(123474);
...
TEST_F(value_cast_int_test, int_to_long_cast)
{
	value v = value_create_int(123474);
...
TEST_F(value_cast_int_test, int_to_float_cast)
{
	value v = value_create_int(123474);
...
TEST_F(value_cast_int_test, int_to_double_cast)
{
	value v = value_create_int(123474);
