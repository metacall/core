...
class value_cast_float_test : public testing::Test
{
  public:
};

TEST_F(value_cast_float_test, float_to_bool_cast)
{
...
TEST_F(value_cast_float_test, float_to_char_cast)
{
	value v = value_create_float(100.324f);
...
TEST_F(value_cast_float_test, float_to_short_cast)
{
	value v = value_create_float(100.324f);
...
TEST_F(value_cast_float_test, float_to_int_cast)
{
	value v = value_create_float(100.324f);
...
TEST_F(value_cast_float_test, float_to_long_cast)
{
	value v = value_create_float(100.324f);
...
TEST_F(value_cast_float_test, float_to_float_cast)
{
	value v = value_create_float(100.324f);
...
TEST_F(value_cast_float_test, float_to_double_cast)
{
	value v = value_create_float(100.324f);
