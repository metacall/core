...
function(rust_package target version script)
	...
	if(CMAKE_SYSTEM_NAME STREQUAL "FreeBSD" AND (CMAKE_CXX_COMPILER_ID STREQUAL "Clang" OR CMAKE_CXX_COMPILER_ID STREQUAL "GNU"))
		set(RUST_EXTRA_FLAGS "-Clink-arg=-Wl,--allow-shlib-undefined")
	endif()
	...
	add_custom_command(TARGET ${custom_target} POST_BUILD
		...
		COMMAND ${Rust_RUSTC_EXECUTABLE} ${RUST_EXTRA_FLAGS} -v --crate-type=dylib -Cprefer-dynamic ${CMAKE_CURRENT_SOURCE_DIR}/source/${script}.rs --out-dir ${PROJECT_OUTPUT_DIR}
	)
