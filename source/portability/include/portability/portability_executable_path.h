...
/* -- Definitions -- */
	...
	#include <windows.h>
	#define PORTABILITY_EXECUTABLE_PATH_SIZE MAX_PATH
	...
	#define PORTABILITY_EXECUTABLE_PATH_SIZE PATH_MAX
...
typedef char portability_executable_path_str[PORTABILITY_EXECUTABLE_PATH_SIZE];
