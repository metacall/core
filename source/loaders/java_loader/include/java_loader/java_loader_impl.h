...
JAVA_LOADER_API int java_loader_impl_execution_path(loader_impl impl, const loader_path path);

JAVA_LOADER_API loader_handle java_loader_impl_load_from_file(loader_impl impl, const loader_path paths[], size_t size, void *data);

JAVA_LOADER_API loader_handle java_loader_impl_load_from_memory(loader_impl impl, const loader_name name, const char *buffer, size_t size, void *data);

JAVA_LOADER_API loader_handle java_loader_impl_load_from_package(loader_impl impl, const loader_path path, void *data);
