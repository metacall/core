...
JL_LOADER_API int jl_loader_impl_execution_path(loader_impl impl, const loader_naming_path path);

JL_LOADER_API loader_handle jl_loader_impl_load_from_file(loader_impl impl, const loader_naming_path paths[], size_t size);

JL_LOADER_API loader_handle jl_loader_impl_load_from_memory(loader_impl impl, const loader_naming_name name, const char *buffer, size_t size);

JL_LOADER_API loader_handle jl_loader_impl_load_from_package(loader_impl impl, const loader_naming_path path);
