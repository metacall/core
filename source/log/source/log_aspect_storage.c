...
LOG_NO_EXPORT static log_aspect_data log_aspect_storage_create(log_aspect aspect, const log_aspect_ctor ctor);

LOG_NO_EXPORT static int log_aspect_storage_impl_append_cb(log_aspect aspect, log_policy policy, log_aspect_notify_data notify_data);

LOG_NO_EXPORT static int log_aspect_storage_impl_append(log_aspect aspect, const log_record record);

LOG_NO_EXPORT static int log_aspect_storage_impl_flush_cb(log_aspect aspect, log_policy policy, log_aspect_notify_data notify_data);

LOG_NO_EXPORT static int log_aspect_storage_impl_flush(log_aspect aspect);

LOG_NO_EXPORT static int log_aspect_storage_destroy(log_aspect aspect);

/* -- Methods -- */

log_aspect_interface log_aspect_storage_interface()
{
	static struct log_aspect_storage_impl_type log_aspect_storage_impl =
	{
