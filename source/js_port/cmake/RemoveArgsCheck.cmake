...
#foreach(generated_file_line ${generated_file})
#    if(${generated_file_line} MATCHES ${js_port_args_check})
##        file(APPEND ${OUTPUT_GENERATED_FILE} "${generated_file_line}")
#        message(STATUS "AAAAAAAAAAAAAAAAAAAAAA")
#    endif()
#endforeach()
