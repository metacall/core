...
function(test_environment_variables target env_vars)
	...
	if(MSVC)
		...
		set(MAKE_LOCAL_DEBUGGER_ENVIRONMENT ${env_vars})

		set(OUTPUT_DIRECTORY_DIR "${PROJECT_BINARY_DIR}")
		string(CONFIGURE "${MAKE_LOCAL_DEBUGGER_ENVIRONMENT}" MAKE_LOCAL_DEBUGGER_ENVIRONMENT @ONLY)

		set_property(TEST ${target}
			PROPERTY ENVIRONMENT "${MAKE_LOCAL_DEBUGGER_ENVIRONMENT}"
		)
	endif()
