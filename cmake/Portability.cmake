...
# Check HP-UX
string(REGEX MATCH "HP-UX" PROJECT_OS_HPUX ${CMAKE_SYSTEM_NAME})

if(PROJECT_OS_HPUX)
	set(PROJECT_OS_HPUX TRUE BOOL INTERNAL)
	set(PROJECT_OS_NAME "HP-UX")
	set(PROJECT_OS_FAMILY hpux)
endif()
...
elseif(PROJECT_OS_FAMILY STREQUAL "qnx")
	set(PROJECT_LIBRARY_PATH_NAME "LD_LIBRARY_PATH")
elseif(PROJECT_OS_FAMILY STREQUAL "vxworks")
	# VxWorks RTP mode uses LD_LIBRARY_PATH; DKM mode loads modules by explicit path.
	set(PROJECT_LIBRARY_PATH_NAME "LD_LIBRARY_PATH")
