	...
	if(NOT EXISTS "${NodeJS_COMPILE_PATH}")
		if(WIN32 AND MSVC)
			...
			if(NodeJS_BUILD_WITHOUT_ICU)
				...
				if("${NodeJS_VERSION_MAJOR}" GREATER_EQUAL "22")
					set(ICU_URL "https://github.com/unicode-org/icu/releases/download/release-75-1/icu4c-75_1-src.zip")
				elseif("${NodeJS_VERSION_MAJOR}" GREATER_EQUAL "20")
					set(ICU_URL "https://github.com/unicode-org/icu/releases/download/release-73-1/icu4c-73_1-src.zip")
				elseif("${NodeJS_VERSION_MAJOR}" GREATER_EQUAL "18")
