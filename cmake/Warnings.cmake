...
if(WARNINGS_ENABLED)
	...
	elseif("${CMAKE_C_COMPILER_ID}" STREQUAL "MSVC")
		...
		set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} /D _CRT_NONSTDC_NO_WARNINGS=1")
	...
	elseif("${CMAKE_C_COMPILER_ID}" STREQUAL "Intel")
		...
		message(STATUS "Unknown C compiler warning level support")
	...
	elseif("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
		...
		set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} /D _CRT_NONSTDC_NO_WARNINGS=1")
