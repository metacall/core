...
function(find_sanitizer NAME)
	...
	elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
		...
		message(STATUS "----------------- CLANG_RUNTIME_CANDIDATES: ${CLANG_RUNTIME_CANDIDATES}")
...
if(SANITIZER_LIBRARIES_PATH)
	...
	elseif(PROJECT_OS_FAMILY MATCHES "macos")
		...
		message(STATUS "----------------- TESTS_SANITIZER_PRELOAD_ENVIRONMENT_VARIABLES: ${TESTS_SANITIZER_PRELOAD_ENVIRONMENT_VARIABLES}")
	endif()
endif()
