...
#define SWIG_V8_VERSION 0x0409385
#endif
...
#define SWIGV8_INIT myextension_initialize




SwigV8ReturnValue _wrap_sum(const SwigV8Arguments& args) {
  v8::HandleScope scope;
  v8::Handle<v8::Value> jsresult;
  int arg1 ;
  int arg2 ;
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_sum.");
...
NODE_MODULE(myextension, myextension_initialize)
#endif
